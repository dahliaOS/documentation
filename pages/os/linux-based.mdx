...
dahliaOS Linux has extensive support for the x86_64 platforma and leverages its power to create a stable, efficient system on every device.
...
<br />
<img src="/docs/os/linux-based/architecture.png" />{" "}
...
<br />
<img src="/docs/os/linux-based/graft.png" />
...
<img src="/docs/os/linux-based/buildroot.png" />
