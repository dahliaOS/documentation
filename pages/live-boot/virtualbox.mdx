...
This guide will walk you through installing dahliaOS on VirtualBox.
...
<img src="/docs/install/virtualbox/virtualbox-create-vm.gif" />{" "}
...
<img src="/docs/install/virtualbox/virtualbox-setting-up-vm.gif" />{" "}
