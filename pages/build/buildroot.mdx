...
2. Go into the cloned buildroot directory and run `make CLANG=1` or if you want to, you can first make changes to Busybox(init), Linux and Buildroot settings, once you're done just run `make CLANG=1`.
