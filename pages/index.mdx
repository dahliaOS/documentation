...
<Callout type="warning" emoji="⚠️">
  dahliaOS is currently in the alpha phase of development meaning most applications it ships with are unfinished, some features are missing and it is not stable nor daily drivable.
</Callout>
